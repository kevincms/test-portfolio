---
title: "Project Context: 새 AI 세션에 작업 맥락을 넘기는 방법"
date: 2026-07-06
lastmod: 2026-09-11
...
기록 방식에 따른 차이를 수치로 확인한 과정은 [후속 글: PDF 벤치마크]({{< relref "/projects/project-context-benchmark-pdf" >}})에 정리했다. 78세션의 입력량·절차 관리·정보 보존을 비교하고, 결과를 해석할 수 있는 범위와 평가의 한계를 다뤘다.
