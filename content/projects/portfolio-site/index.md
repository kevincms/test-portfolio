...
> 사실 이 플랫폼에 도착하기까지는 Notion·openclaw에서 시작해 Hugo 테마를 전전한 열흘간의 시행착오가 있었다. "dev-portfolio는 테마가 아니라 site starter였다"는 깨달음과 설치 지옥(pnpm·Go·OneDrive 충돌)을 따로 정리했다.
> → 자세한 여정: [**포트폴리오 플랫폼 여정 — Notion에서 Hugo Blox까지 열흘**](/blog/portfolio-platform-journey/)
